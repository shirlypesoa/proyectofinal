...
public class ActividadIngresoU extends AppCompatActivity
{
    ...
    public void Volver3 (View Vista){
        Intent Volver;
        Volver = new Intent(ActividadIngresoU.this, Actividad_Inicial.class);
    ...
    public void ingresou (View Vista)
    {
        Usu=(EditText)findViewById(R.id.usuU);
        Contra=(EditText)findViewById(R.id.contraU);
        Usu2=Usu.getText().toString();
        encontra2=Contra.getText().toString();
        Ingresar=(Button)findViewById(R.id.ingresou);

        if(BaseDeDatosAbierta())
        {
            int cantidadderegistros=0;
            Cursor Conjuntoderegistros;
            Conjuntoderegistros=BaseDeDatos.rawQuery("select usuario from usuarios where usuario = '"+Usu2 + "'", null);
            ...
            if (cantidadderegistros>0)
            {
                ...
                Conjuntoderegistros2=BaseDeDatos.rawQuery("select usuario from usuarios where usuario = '"+Usu2 + "'", null);
                ...
                if (contraseña.compareTo(encontra2)==0){
                    String EresUnCacahuateSi;
                    EresUnCacahuateSi="¡Bienvenido, " + Usu2 + "!";
                    MostrarMensaje(EresUnCacahuateSi);
                    Intent Aplicacion;
                    Aplicacion = new Intent(ActividadIngresoU.this, MapsActivity.class);
                    startActivity(Aplicacion);

                }else
                {
                    String EresUnCacahuateSi;
                    EresUnCacahuateSi="Datos incorrectos";
                    MostrarMensaje(EresUnCacahuateSi);
                }
    }
}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ingreso_u);
    }
